...
/** Acceso a la gestión de menús del comedor (lista por fecha); se muestra en la grilla del Portal, no en la barra superior. */
export const menusDelDiaNavItem: NavItem = {
  path: '/menus',
  label: 'Menús del día',
  permiso: 'MENUS:VER',
  icon: (
